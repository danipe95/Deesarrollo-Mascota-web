...
namespace Mascoticas.App.Persistencia.AppRepositorios
{
    public class RepositorioMascota : IRepositorioMascota
    {
        ...
        {    
            ...
            {
                new Mascota{IdMascota=1, Nombre="firulais", Tipo="perro", Raza="Huzki", /*Propietario=Daniel,*/Peso="30 kg",Temperatura="37°c", FrecuenciaCardiaca="baja", FrecuenciaRespiratoria="alta", EstadoAnimo="modo avion",Recomendaciones="mas croketas"},
                new Mascota{IdMascota=2, Nombre="luka", Tipo="gato", Raza="mao", /*Propietario="Amelia",*/Peso="19 kg",Temperatura="39°c", FrecuenciaCardiaca="elevada", FrecuenciaRespiratoria="baja", EstadoAnimo="modo avion",Recomendaciones="penicilina"},
                new Mascota{IdMascota=3, Nombre="piolin", Tipo="loro", Raza="australiano", /*Propietario="Katherine",*/Peso="60 gr",Temperatura="36°c", FrecuenciaCardiaca="normal", FrecuenciaRespiratoria="normal", EstadoAnimo="bueno", Recomendaciones="ninguna"}
                };
        }
        ...
        {
            var mascotaEncontrada = _appContext.Mascotas.FirstOrDefault(c => c.IdMascota == IdMascota);
        ...
        {
            return mascota.SingleOrDefault(m => m.IdMascota==mascotaId);
        }
